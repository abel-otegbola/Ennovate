    ...
    return (
        <div className="">
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-[30px] py-[30px] md:px-[9%] px-[3%] border border-transparent border-t-gray-200/[0.09]">
                ...
                <ul className="w-full">
                    <h2 className="py-2 text-lg font-bold">Support</h2>
                ...
                <ul className="w-full">
                    <h2 className="py-2 text-lg font-bold">Resources and Blogs</h2>
            ...
            <div className="bg-gray-200 dark:bg-gray-100/[0.09] text-center">
