        ...
        <main>
            <header className="flex flex-wrap jutify-between items-center">
                <div className="md:w-[50%] w-full px-[5%] md:py-0 py-[10%]">
                    ...
                    <h1 className="py-[3%] md:text-[40px] text-[30px] bg-clip-text text-transparent bg-gradient-to-r from-purple to-green">Making Renewable Energy  more accessible, affordable and fun</h1>
