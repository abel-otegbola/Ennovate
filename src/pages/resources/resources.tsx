...
import householdAppliances, { HouseholdAppliances } from './appliances';
...
export default function Resources() {
    ...
    const { appliances }: HouseholdAppliances = householdAppliances;
                        ...
                        <table className="w-full my-6">
                            <thead className="">
                                <tr className="text-left border border-transparent border-b-gray-500/[0.4]">
                                    ...
                                    <th className="p-2">Household Device</th>
                            ...
                            <tbody>
                            {
                                appliances.map((item: any, i: number) => (
                                    <tr className=" border border-transparent border-b-gray-400/[0.08]">
                                        <td className="p-2">{i + 1}</td>
                                        <td className="p-2">{item.appliance}</td>
                                        <td className="p-2">1</td>
                                        <td className="p-2">{item.consumption_kwh}</td>
                                        <td className="p-2"><input type="checkbox" className="text-lg bg-purple" /></td>
                                    </tr>
                                ))
                            }
                            </tbody>
